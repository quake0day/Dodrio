...
def download_papers(user_id):
    ...
    driver = webdriver.Chrome(executable_path='/var/www/FlaskApp/FlaskApp/db/chromedriver', options=chrome_options)
    driver.get(url)
...
if __name__ == '__main__':
    ...
    print(papers)
    database_path = "/var/www/FlaskApp/FlaskApp/db/information_.db"
